...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="../../index2.html"><b>Booking</b> App</a>
        </div>
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="number" class="form-control @error('telephone') is-invalid @enderror" placeholder="Phone Number" name="telephone" value="{{ old('telephone') }}" required autocomplete="telephone">
                        <div class="input-group-append">
                            <div class="input-group-text">
