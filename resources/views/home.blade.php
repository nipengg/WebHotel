                    ...
                    <ul class="popular-list">
                        ...
                        <li>
                            <div class="popular-card">
                                ...
                                <figure class="card-img">
                                    <img src="{{ asset('Client/assets/images/popular-1.jpg') }}" alt="San miguel, italy" loading="lazy">
                                </figure>
                        ...
                        <li>
                            <div class="popular-card">
                                ...
                                <figure class="card-img">
                                    <img src="{{ asset('Client/assets/images/popular-2.jpg') }}" alt="Burj khalifa, dubai" loading="lazy">
                                </figure>
                        ...
                        <li>
                            <div class="popular-card">
                                ...
                                <figure class="card-img">
                                    <img src="{{ asset('Client/assets/images/popular-3.jpg') }}" alt="Kyoto temple, japan" loading="lazy">
                                </figure>
                    ...
                    <ul class="package-list">
                        ...
                        <li>
                            <div class="package-card">
                                ...
                                <figure class="card-banner">
                                    <img src="./assets/images/packege-1.jpg" alt="Experience The Great Holiday On Beach"
                                        loading="lazy">
                                </figure>
                        ...
                        <li>
                            <div class="package-card">
                                ...
                                <figure class="card-banner">
                                    <img src="./assets/images/packege-2.jpg" alt="Summer Holiday To The Oxolotan River"
                                        loading="lazy">
                                </figure>
                        ...
                        <li>
                            <div class="package-card">
                                ...
                                <figure class="card-banner">
                                    <img src="./assets/images/packege-3.jpg" alt="Santorini Island's Weekend Vacation"
                                        loading="lazy">
                                </figure>
