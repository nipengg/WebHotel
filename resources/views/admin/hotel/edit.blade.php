...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Hotel {{ $hotel->NamaHotel }}</h1>
                </div>
                <div class="col-sm-6">
            ...
            <form action="{{ route('admin.hotel.update', $hotel->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $hotel->NamaHotel }}" autocomplete="off" class="form-control" id="name"
                            name="name" placeholder="Nama Hotel" required>
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat Hotel</label>
                        <textarea id="alamat" name="alamat" class="form-control" rows="3" placeholder="Alamat Hotel" required>{{ $hotel->AlamatHotel }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="no_telp">No Telp Hotel</label>
                        <input value="{{ $hotel->NoTelpHotel }}" type="number" autocomplete="off" class="form-control"
                            id="no_telp" name="no_telp" placeholder="No Telp Hotel" required>
                    </div>
                    <div class="form-group">
                        <label for="files">Foto Hotel (Biarkan jika gambar tidak ingin di update)</label>
